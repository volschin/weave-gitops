...
Export these environment variables to configure CAPI experience. Adjust them to your context.
...
The following Makefile is supplied to help you with each stage.
