...
- [List Generator](./list-generator.mdx): The simplest generator. Provide a list of Key/Value pairs that you want to feed the template with.
...
This is especially true for the `GitRepository` generator, where the consequences of the template rendering may not be obvious to the author of the files or the author of the template.
