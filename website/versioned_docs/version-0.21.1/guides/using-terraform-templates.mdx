...
<details><summary>Expand to see ./clusters/management/tf-template.yaml</summary>
...
<details><summary>Expand to see Terraform manifest</summary>
...
<details><summary>Expand to see Terraform manifest at
